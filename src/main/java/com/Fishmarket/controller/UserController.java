...
import com.Fishmarket.bean.GoodsCarBean;
import com.Fishmarket.bean.ShopInformationBean;
import com.Fishmarket.bean.UserWantBean;
import com.Fishmarket.pojo.*;
import com.Fishmarket.response.BaseResponse;
import com.Fishmarket.service.*;
import com.Fishmarket.token.TokenProccessor;
import com.Fishmarket.tool.SaveSession;
import com.Fishmarket.tool.StringUtils;
...
//        //从session中获得用户的基本信息
        ...
        if (action == 1) {
            ...
            String random;
            String path = "E:\\mySSM\\src\\main\\webapp\\", save = "";
            random = "img\\publishshop\\" + StringUtils.getInstance().getRandomChar() + System.currentTimeMillis() + ".jpg";
